...
class ZJetsAnalysis:
    ...
    def run(self):
        ...
        # z_pt vs leading jet pt, truth jet pt
        ...
        # truth jet pt vs reco jet pt
        hist_pt_truth_jet_vs_leading_jet= make_numpy_hists_2d("hist_pt_truth_jet_vs_leading_jet",
                                   "", x_bin_edges, truth_jet_pt, y_bin_edges,leading_jet_pt)
        self.histograms["hist_pt_truth_jet_vs_leading_jet"] = hist_pt_truth_jet_vs_leading_jet

        # truth_jet_pt vs reco jet pt at different scales from cluster
        ...
        # z_pt vs jet pt at different energy scales
        ...
        hist_median_ml = make_hist_from_bin_contents("hist_mean_ml", "", truth_z_pt_bins, median_ml)
        hist_median_truth = make_hist_from_bin_contents("hist_mean_truth", "", truth_z_pt_bins, median_truth)
        hist_sigma_em = make_hist_from_bin_contents("hist_sigma_em", "", truth_z_pt_bins, sigma_em/2*median_em)
        hist_sigma_lcw = make_hist_from_bin_contents("hist_sigma_lcw", "", truth_z_pt_bins, sigma_lcw/2*median_lcw)
        hist_sigma_ml = make_hist_from_bin_contents("hist_sigma_ml", "", truth_z_pt_bins, sigma_ml/2*median_ml)
        hist_sigma_truth = make_hist_from_bin_contents("hist_sigma_truth", "", truth_z_pt_bins, sigma_truth/2*median_truth)
